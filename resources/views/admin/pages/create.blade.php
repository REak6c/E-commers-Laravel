...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="mb-0 fw-bold">{{ __('cms.pages.create') }}</h4>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small">{{ __('cms.pages.publishing_hint') }}</p>
                    <div class="d-grid mt-4">
                        <button type="submit" class="btn btn-primary shadow-sm py-2">
                            <i class="bi bi-save me-1"></i> {{ __('cms.pages.form_save') ?? 'Save Page' }}
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mb-3">
                        <div class="image-upload-wrapper">
                            ...
                            <div class="placeholder-preview mb-3 text-center bg-light rounded py-4 border-2 border-dashed pointer-cursor"
                                ...
                                <p class="text-muted small mt-2 mb-0">{{ __('cms.pages.click_to_upload') }}</p>
                            </div>
                            @endif

                            <div class="d-grid">
                                <label class="btn btn-outline-primary btn-sm" for="image_file_en">
                                    <i class="bi bi-cloud-arrow-up me-1"></i> {{ __('cms.pages.choose_image') }}
                                </label>
