...
<div class="row">
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-4">
                <h6 class="fw-bold mb-4">{{ 'Payment Information' }}</h6>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-4">
                <h6 class="fw-bold mb-4">{{ 'User & Order' }}</h6>

                <div class="mb-3">
                    <label class="form-label text-muted small fw-bold text-uppercase mb-1">{{ 'User'
                        }}</label>
                ...
                <div class="mb-3">
                    <label class="form-label text-muted small fw-bold text-uppercase mb-1">{{ 'Order'
                        }}</label>
