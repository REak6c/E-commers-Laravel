...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="mb-0 fw-bold">{{ __('cms.currencies.edit_currency') ?? 'Edit Currency' }}</h4>
                ...
                <div class="card-body p-4">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control border-0 bg-light @error('name') is-invalid @enderror"
                                value="{{ old('name', $currency->name) }}" required placeholder="e.g. US Dollar">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="code" class="form-control border-0 bg-light @error('code') is-invalid @enderror"
                                value="{{ old('code', $currency->code) }}" required placeholder="e.g. USD">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="symbol" class="form-control border-0 bg-light @error('symbol') is-invalid @enderror"
                                value="{{ old('symbol', $currency->symbol) }}" required placeholder="e.g. $">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.0001" name="exchange_rate"
                                    ...
                                    value="{{ old('exchange_rate', $currency->exchange_rate) }}" required placeholder="1.0000">
                    ...
                    <div class="text-end pt-3">
                        <button type="submit" class="btn btn-primary px-5 shadow-sm">
                            <i class="bi bi-save me-1"></i> {{ __('cms.common.update') ?? 'Update Currency' }}
                        </button>
                    </div>
                </div>
            </div>
