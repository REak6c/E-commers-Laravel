...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="mb-0 fw-bold">{{ __('cms.menu_items.create') }}</h4>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-0">
                        ...
                        <input type="text" name="title[en]"
                            ...
                            value="{{ old('title.en') }}" placeholder="{{ __('cms.menu_items.title_placeholder') }}">
                        @error('title.en')
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <x-admin.select
                        ...
                        :selected="$menu->id"
                        :placeholder="__('cms.menu_items.select_menu')"
                    ...
                    <div class="d-grid pt-2">
                        <button type="submit" class="btn btn-primary shadow-sm py-2">
                            <i class="bi bi-plus-lg me-1"></i> {{ __('cms.menu_items.button') }}
                        </button>
                    </div>
                </div>
            </div>
