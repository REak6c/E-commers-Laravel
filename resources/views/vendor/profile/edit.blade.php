...
<div class="vp-page-header">
    <div class="vp-page-header__left">
        <h1 class="vp-page-header__title">
            <span class="vp-page-header__title-icon"><i class="fas fa-user-circle"></i></span>
            My Profile
        </h1>
    ...
    <div class="vp-page-header__actions">
        <span class="badge d-inline-flex align-items-center gap-2"
              style="background:var(--vp-primary-bg);color:var(--vp-primary);font-size:.78rem;font-weight:700;padding:7px 14px;border-radius:20px;border:1px solid #c7d2fe;">
...
<div class="row g-4">
            ...
            <div class="vp-card-body" style="padding:28px 24px;text-align:center;">
                ...
                <div style="position:relative;display:inline-block;margin-bottom:16px;">
                    <img id="profilePreview"
                         ...
                         alt="Profile"
                         style="width:110px;height:110px;border-radius:50%;object-fit:cover;border:4px solid var(--vp-primary-bg);box-shadow:0 0 0 3px rgba(99,102,241,.18),0 4px 16px rgba(0,0,0,.10);">

                    <label for="profile_image"
                           style="position:absolute;bottom:4px;right:4px;width:32px;height:32px;border-radius:50%;background:var(--vp-primary);color:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:.75rem;border:2px solid #fff;box-shadow:0 2px 8px rgba(99,102,241,.35);transition:background .18s;"
                           title="Change Photo"
                ...
                <h5 style="font-size:1rem;font-weight:700;color:var(--vp-text);margin:0 0 4px;">{{ $vendor->name }}</h5>
                <p style="font-size:.78rem;color:var(--vp-text-muted);margin:0;">{{ $vendor->email }}</p>
            </div>
        </div>
    ...
    <div class="col-lg-8 col-xl-9">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="vp-form-group mb-0">
                            <label class="vp-label" for="name">Full Name <span class="required">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="vp-form-group mb-0">
                            <label class="vp-label" for="email">Email Address <span class="required">*</span></label>
                            <div class="vp-input-group">
        ...
        <div class="vp-card mb-4">
            <div class="vp-card-header">
                <h6 class="vp-card-header__title">
                    <span class="vp-card-header__icon" style="background:#f0fdf4;color:#16a34a;">
                        <i class="fas fa-shield-alt"></i>
                    </span>
                    Security &amp; Password
                </h6>
                <span style="font-size:.72rem;color:var(--vp-text-muted);">Leave blank to keep current password</span>
            </div>
            <div class="vp-card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="vp-form-group mb-0">
                            <label class="vp-label" for="password_confirmation">Confirm New Password</label>
                            <div class="vp-input-group">
                                <span class="vp-input-group-icon"><i class="fas fa-key"></i></span>
