...
<nav id="sidebar" class="d-flex flex-column">
    ...
    <div class="sidebar-brand" id="sidebarBrand">
        <div class="brand-logo">
            <img src="{{ asset('storage/logo_icon/shopping.png') }}" alt="{{ __('cms.sidebar.logo') }}" class="logo-img">
        </div>
    ...
    <div class="sidebar-search" id="sidebarSearch">
        <div class="search-wrapper">
            ...
            <input type="text" placeholder="{{ __('cms.sidebar.search_placeholder') }}" id="searchInput" autocomplete="off">
        </div>
    </div>
        ...
        <ul class="sidebar-menu" id="sidebarMenu">
            ...
            <li class="menu-item has-submenu {{ in_array(Route::currentRouteName(), ['vendor.products.create','vendor.products.index','vendor.products.edit']) ? 'open' : '' }}">
                ...
                <div class="collapse submenu {{ in_array(Route::currentRouteName(), ['vendor.products.create','vendor.products.index','vendor.products.edit']) ? 'show' : '' }}" id="productMenu">
                    <ul class="submenu-list">
                        <li><a class="submenu-link {{ Route::currentRouteName() == 'vendor.products.create' ? 'active' : '' }}" href="{{ route('vendor.products.create') }}"><i class="fas fa-plus-circle me-2"></i>{{ __('cms.sidebar.products.add_new') }}</a></li>
                        <li><a class="submenu-link {{ Route::currentRouteName() == 'vendor.products.index' ? 'active' : '' }}" href="{{ route('vendor.products.index') }}"><i class="fas fa-list me-2"></i>{{ __('cms.sidebar.products.list') }}</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="menu-item has-submenu {{ Route::is('vendor.orders.*') ? 'open' : '' }}">
                ...
                <div class="collapse submenu {{ Route::is('vendor.orders.*') ? 'show' : '' }}" id="orderMenu">
                    <ul class="submenu-list">
                        <li><a class="submenu-link {{ Route::currentRouteName() == 'vendor.orders.index' ? 'active' : '' }}" href="{{ route('vendor.orders.index') }}"><i class="fas fa-inbox me-2"></i>{{ __('cms.sidebar.orders.list') }}</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="menu-item has-submenu {{ in_array(Route::currentRouteName(), ['vendor.reviews.index']) ? 'open' : '' }}">
                ...
                <div class="collapse submenu {{ in_array(Route::currentRouteName(), ['vendor.reviews.index']) ? 'show' : '' }}" id="vendorProductReviewMenu">
                    <ul class="submenu-list">
                        <li><a class="submenu-link {{ Route::currentRouteName() == 'vendor.reviews.index' ? 'active' : '' }}" href="{{ route('vendor.reviews.index') }}"><i class="fas fa-list me-2"></i>{{ __('cms.sidebar.product_reviews.list') }}</a></li>
                    </ul>
                </div>
            </li>
