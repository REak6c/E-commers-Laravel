...
class Install extends Command
{
     ...
     * @var string
     */
    protected $signature = 'install:tvr {--locale= : Set the application locale} {--with-import : Import default data}';
    ...
    public function handle()
    {
        ...
        $availableLocales = ['en' => 'English', 'kh' => 'Khmer', 'zh' => 'Chinese'];
        ...
        $this->info('TVR installation completed successfully.');
